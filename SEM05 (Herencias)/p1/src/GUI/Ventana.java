...
public class Ventana extends JFrame implements ActionListener {
	...
	public Ventana() {
		...
		mnNewMenu_1 = new JMenu("Figuras");
		menuBar.add(mnNewMenu_1);
		
		mntmNewMenuItem_1 = new JMenuItem("Círculo");
		mntmNewMenuItem_1.addActionListener(this);
		mnNewMenu_1.add(mntmNewMenuItem_1);
		
		mntmNewMenuItem_2 = new JMenuItem("Cilindro");
	...
	protected void do_mntmNewMenuItem_1_actionPerformed(ActionEvent e) {
		...
		ci.setVisible(true); //para visibilisar el otro formulario
	}
